...
<img src="screen/Selects(8)/Queries1-A.png" alt="Screenshot Select">
 ...
 <img src="screen/Selects(8)/Queries1-B.png" alt="Screenshot Select">
...
*   **צורות כתיבה:** (ראו קובץ Queries.sql)
    *   אופציה א': JOIN מפורש.
<img src="screen/Selects(8)/Queries2-A.png" alt="Screenshot Select">

*   אופציה ב': שימוש ב-IN עם תתי שאילתות מקוננות
<img src="screen/Selects(8)/Queries2-B.png" alt="Screenshot Select">
...
<img src="screen/Selects(8)/Queries3-A.png" alt="Screenshot Select">
    *   אופציה ב': שימוש ב-CTE (With statement).
<img src="screen/Selects(8)/Queries3-B.png" alt="Screenshot Select">
...
*   **צורות כתיבה:** (ראו קובץ Queries.sql)
    *   אופציה א': JOIN פשוט.
<img src="screen/Selects(8)/Queries4-A.png" alt="Screenshot Select">
    *   אופציה ב': תת שאילתה בתוך ה-SELECT.
<img src="screen/Selects(8)/Queries4-B.png" alt="Screenshot Select">
...
<img src="screen/Selects(8)/Queries5.png" alt="Screenshot Select">
*   **שאילתה 6:** לקוחות עם מאזן נקודות גבוה מהממוצע ברמה שלהם (שימוש בתת-שאילתה והשוואה)
<img src="screen/Selects(8)/Queries 6.png" alt="Screenshot Select">
*   **שאילתה 7:** חשיפה כוללת של פלטפורמות לפי קטגוריה בשנת 2025 (שימוש בפירוק תאריך).
<img src="screen/Selects(8)/Queries 7.png" alt="Screenshot Select">

* **שאילתה 8:** שלושת המוצרים היקרים ביותר בכל קטגוריה (שימוש ב-Window Functions).

<img src="screen/Selects(8)/Queries 8.png" alt="Screenshot Select">
